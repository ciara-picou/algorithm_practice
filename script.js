...
function sumFinder(arr, num) {
  ...
  for (let i = 0; i < arr.length; i++) {
    // add every remaining element to the single element we grabbed from the array in the outer loop
    ...
    // j will be incremented within the inner loop
     //i will only be incremented once we break out of the inner loop  
